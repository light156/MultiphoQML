...
args = {'in_config': torch.as_tensor([1/sqrt(2), 0, 0, 0, 0, 1/sqrt(2)*1j], dtype=torch.complex128),
        'out_config_list': None,
        'photon_num': 1}
...
save_dir = get_folder('metric_learning', prefix=f'hardware_n=1_{threshold:.2f}_seed_{seed}')
...
def fake_real_experiment(batch_theta_phi_list):
    ...
    for theta_list, phi_list in batch_theta_phi_list:
        ...
        complex_amplitude = unitary @ args['in_config']
